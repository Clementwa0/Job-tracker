import { ACTION_VERBS, ATS_UNFRIENDLY_TOKENS, RESUME_LENGTH_TARGET, scoreBand, STOP_WORDS, WEAK_PHRASES, type ScoreBand } from "@/features/jobseeker/resumes/constants/atsConstants";
import type { ResumeData } from "@/types/resume-builder";
import { resumeToPlainText, wordCount, keywordMatches } from "@/features/jobseeker/resumes/utils/resumeText";
