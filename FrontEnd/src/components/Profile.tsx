                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Requires a code from your authenticator app to log in
                    </p>
                  </div>
                  <Switch
                    id="twoFactor"
        ...
        <TabsContent value="notifications">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage how you receive notifications from JobTrail.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-gray-500">
                    Get notified about updates to your job applications
                  </p>
                </div>
                <Switch
                  id="jobUpdates"
