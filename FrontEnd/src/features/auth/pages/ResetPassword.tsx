    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-900">
      <Card className="w-full max-w-md shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 p-6">
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-500/20 text-red-100 rounded-lg text-sm border border-red-500/30">
              {error}
            </div>
          )}
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-white text-blue-900 hover:bg-white/90 transition-all shadow-md"
              >
