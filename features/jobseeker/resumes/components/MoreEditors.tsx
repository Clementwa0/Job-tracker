  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center">
        ...
        <p className="text-sm text-muted-foreground dark:text-muted-foreground">No certifications added yet</p>
  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      {items.map((c, i) => (
        <div
          key={c.id}
          className="group relative rounded-xl border border-border bg-card p-4 shadow-sm transition-all hover:shadow-md bg-card/50 sm:p-5"
        >
          ...
          <div className="mb-4 flex items-start gap-3">
            ...
            <div className="flex items-center gap-1 ml-2 flex-shrink-0">
              ...
              <button
                type="button"
                onClick={() => remove(c.id)}
                className="rounded-lg p-2 text-muted-foreground hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-900/20 dark:hover:text-red-400 transition-colors"
...
export function LanguagesEditor({
  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center">
        <Languages className="h-12 w-12 text-muted-foreground/40 mb-3" />
        <p className="text-sm text-muted-foreground dark:text-muted-foreground">No languages added yet</p>
        <p className="text-xs text-muted-foreground dark:text-muted-foreground mt-1">
  ...
  return (
    <div className="flex items-center gap-0.5">
      <button
        ...
        onClick={onUp}
        disabled={first}
        className="rounded-lg p-2 text-muted-foreground hover:bg-muted hover:text-foreground disabled:opacity-30 disabled:hover:bg-transparent transition-all"
        aria-label="Move up"
      >
