...
import { aiService, type ImproveKind } from "@/features/jobseeker/resumes/services/ai.client";
  ...
  return (
    <div className="relative">
      <button
        ...
        onClick={run}
        disabled={loading}
        className={`${baseCls} border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 disabled:opacity-50 dark:border-blue-900/50 dark:bg-blue-950/40 dark:text-blue-300`}
      >
            ...
            {variants.map((v, i) => (
              <li key={i}>
                <button
                  ...
                  className="block w-full rounded-md p-2 text-left text-xs text-foreground hover:bg-blue-50 dark:hover:bg-blue-950/40"
                >
                  {v}
                </button>
              </li>
