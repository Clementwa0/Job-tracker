...
import type { ScoreMetrics } from "@/features/jobseeker/cv-review/components/ScoreMetrics";
...
> = ({ score, scoreMetrics }) => {
  return (
    <Card className="lg:col-span-2 overflow-hidden border-0 shadow-xl bg-gradient-to-br from-card via-card to-blue-50 dark:to-blue-950/30">
      <CardHeader>
