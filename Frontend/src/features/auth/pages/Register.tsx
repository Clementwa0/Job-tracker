  ...
  return (
    <div className="flex h-screen overflow-hidden">
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-white truncate">{feature.desc}</p>
                  </div>
                </div>
              );
            })}
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-6 bg-animated relative overflow-hidden">
        ...
        <div
          ref={formRef}
          className="w-full max-w-sm bg-white/5 backdrop-blur-md border border-gray-200 rounded-2xl p-6 shadow-lg relative z-10"
        >
