...
function fmtRange(
  ...
  const s = start
    ? new Date(start + "-01").toLocaleDateString(
        undefined,
        {
          month: "short",
          year: "numeric",
  ...
  const e = current
    ? "Present"
    : end
      ? new Date(end + "-01").toLocaleDateString(
          undefined,
          {
            month: "short",
            year: "numeric",
...
export default function ResumePreview({
  ...
  return (
    <article
      id="resume-print"
      className="resume-paper mx-auto bg-white text-gray-900 shadow-xl ring-1 ring-gray-200 print:shadow-none print:ring-0"
      style={
        {
          width: "8.5in",
          minHeight: "11in",
